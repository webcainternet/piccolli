			...
			<div class="<?php echo $content_right; ?> product_page-right">
				...
				<div id="product">
					...
					<div class="form-group form-horizontal">
						...
						<button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="product-btn-add"><i class="material-design-shopping232"></i><span><?php echo $button_cart; ?></span></button>
					</div>

					<ul class="product-buttons">
						<li><button class="product-btn" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="material-design-rate"></i> <span class="hidden-xs hidden-sm"><?php echo $button_wishlist; ?></span></button></li>
						<li><button type="button" class="product-btn" onclick="compare.add('<?php echo $product_id; ?>');"><i class="material-design-shuffle24"></i> <span class="hidden-xs hidden-sm"><?php echo $button_compare; ?></span></button></li>
					</ul>					
