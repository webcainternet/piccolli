...
<div id="cart" class="cart">
	<button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="dropdown-toggle">
		<span style="margin-right: 30px;"><i class="fa fa-map-marker" aria-hidden="true" style="font-size: 26px;"></i> Onde estamos</span>
  ...
  <ul class="dropdown-menu pull-right">
	...
	<li>
	  <div>
		...
		<p class="text-right">
			<a class="btn btn-default" href="<?php echo $cart; ?>"><!--<i class="fa fa-shopping-cart"></i>--> <?php echo $text_cart; ?></a>
