...
<div id="page">
    ...
    <header class="header">
        ...
        <div style="display: inline-block; width: 780px;">
		...
		<div class="top-menu toggle-wrap">
			...
			<div class="toggle_cont">
				...
				<div class="top-block hidden-xs">
					<ul class="list-unstyled">
						<?php if ($logged) { ?>
						<li><a href="<?php echo $logout; ?>"><i class="material-design-exit13"></i><span><?php echo $text_logout; ?></span></a></li>
						<?php } else { ?>
						<li><a href="<?php echo $login; ?>"><i class="material-design-https"></i><span><?php echo $text_login; ?></span></a></li>
						<?php } ?>
						<li><a href="<?php echo $register; ?>"><i class="material-design-add184 "></i><span><?php echo $text_register; ?></span></a></li>
					</ul>
				</div>
...
<?php /*
        <div class="container">
    		...
    		<div id="stuck" class="menu-block">
    			...
    			<div class="pull-left">
                <?php if ($categories) { ?>
    				<div id="menu-gadget" class="menu-gadget full">
